  ...
  forbidden: [
    {
      ...
      to: { path: '^apps/web/src/(entities|features|widgets|views|app)' },
    },
    {
      ...
      to: { path: '^apps/web/src/(features|widgets|views|app)' },
    },
    {
      ...
      to: { path: '^apps/web/src/(widgets|views|app)' },
    },
    {
      ...
      to: { path: '^apps/web/src/(views|app)' },
    },
    {
